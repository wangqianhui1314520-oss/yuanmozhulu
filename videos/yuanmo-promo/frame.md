...
description: >
  ...
  the three-face stack (Shrikhand display tilted at poster scale, Noto Serif SC serif body,
...
typography:
  # — reading + chrome ramp —
  body:    { fontFamily: "Noto Serif SC", cqw: 0.85, weight: 400, lineHeight: 1.75, color: "dark" }
  body-cell:{ fontFamily: "Noto Serif SC", cqw: 0.7, weight: 400, lineHeight: 1.55 }
...
- **Fonts** — already set to **Noto Serif SC** (display) / **Noto Sans SC** (body); ignore any preset font name lingering in prose.
...
- **Noto Serif SC serif body** (line 1.75); **Space Grotesk** chrome (uppercase tracked).
...
- **Shrikhand + Noto Serif SC + Space Grotesk via Google Fonts.** CJK: Noto Serif SC 900/400 + Noto Sans SC; Shrikhand's slab-script has no Hanzi equal — keep tilts + red + double-borders to carry the identity.
